...
public class IncomingFragment extends Fragment {
    ...
    public static class RecyclerTouchListener implements RecyclerView.OnItemTouchListener {
        ...
        private IncomingFragment.ClickListener clickListener;

        public RecyclerTouchListener(Context context, final RecyclerView recyclerView, final IncomingFragment.ClickListener clickListener) {
